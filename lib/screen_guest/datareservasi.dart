                ...
                return Padding(
                  ...
                  child: Column(
                    children: [
                        ...
                        calendarBuilders: CalendarBuilders(
                          defaultBuilder: (context, date, _) {
                            List<dynamic>? bookings =
                                acceptedBookings[DateTime(date.year, date.month, date.day)];
                            ...
                            return GestureDetector(
                              onTap: () {
                                ...
                                if (bookings != null && bookings.isNotEmpty) {
                                  if (bookings.any((booking) => booking['status'] == 'Maintenance')) {
                                    showDialog(
                                      context: context,
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          title: Text('Maintenance'),
                                          content: Text('Ruangan sedang maintenance'),
                                          actions: [
                                            TextButton(
                                              onPressed: () {
                      ...
                      SizedBox(height: 6),
                      _buildLegendItem(Colors.yellow, 'Sudah dipesan satu sesi'),
                      SizedBox(height: 6),
